...
class randomWriter:
    ...
    def makeBoys(self):
        ...
        """
        try:
            with open('./dat/boys.csv', 'w') as csvfile:
            ...
            print('Oops!!\nIncorrect path, no such path exists for the boys file')
            sys.exit()
    ...
    def makeGirls(self):
        ...
        try:
            ...
            print('Oops!!\nIncorrect path, no such path exists for the girls file')
            sys.exit()
    ...
    def makeGifts(self):
        ...
        try:
            ...
            print('Oops!!\nIncorrect path, no such path exists for the gifts file')
            sys.exit()